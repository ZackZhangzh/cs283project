...
def joint_angle_client(angle_set):
    ...
    goal.angles.joint1 = 360.0
    goal.angles.joint2 = 180.0
    goal.angles.joint3 = 180.0
    goal.angles.joint4 = 0.0
...
if __name__ == '__main__':
    ...
    print('Joint values now in degree are: ')
    print(', '.join('joint{:1.0f} {:3.1f}'.format(k[0] + 1, k[1]) for k in enumerate(currentJointCommand)))
